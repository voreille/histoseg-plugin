...
def demo_single_wsi():
    ...
    wsi_path = Path("/home/val/data/DHMC_LUAD/test_corrected/DHMC_0010.tif"
                    )  # Replace with actual WSI file
    ...
    result = process_single_wsi(wsi_path=wsi_path,
...
def demo_directory():
    ...
    # Example paths (adjust as needed)
    source_dir = Path("/home/val/data/DHMC_LUAD/test_corrected"
    ...
    results = process_wsi_directory(source_dir=source_dir,
                                    output_dir=output_dir,
                                    patch_size=256,
                                    step_size=256,
                                    patch_level=0,
